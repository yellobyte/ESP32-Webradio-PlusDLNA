...
//
#define index_html_version 210201
...
<html>
 ...
 <body>
  ...
  <center>
   ...
   <button class="button" onclick="httpGet('status')">INFO</button>
   <button class="button" onclick="httpGet('test')">TEST</button>
   <table style="width:500px">
    <tr>
     <td colspan="2"><center>
       <label for="preset"><big>Preset Radio Stations:</big></label>
       <br>
       <select class="select selectw" onChange="handlepreset(this)" id="preset">
        <option value="-1">Select a preset station here</option>
       </select>
       <br><br>
     </center></td>
    </tr>
   ...
   <p>Examples: uk2.internet-radio.com:8358/, scast.regenbogen.de/dpop-128-mp3, 85.17.121.103:8800</p><br>
  </center>
  <script>
